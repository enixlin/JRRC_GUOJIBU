...
<td><input name="UserList[${status.index}].name" value=${user.name} width="100%" border=0></td>
<td><input name="UserList[${status.index}].password" value=${user.password} border=0></td>
<td><input name="UserList[${status.index}].status" value=${user.status} border=0></td>
<td align="center">
    <a href="" id=${user.id} onclick="DeleteUser(id)" >删除</a></td>
